...
const translations = {
  ...
  ro: {
    ...
    intro: 'Salut, sunt Fabian. Aici vei gasi o colectie de proiecte open source.',
    liveProjects: 'Proiecte Live',
    repositories: 'Cod Sursa',
    ...
    bookingTitle: 'Booking Filter Out',
    bookingDesc:
      'O extensie de browser pentru a estompa locatiile care accepta animale de companie pe booking.com.',
    visitSite: 'Viziteaza →',
    viewGithub: 'Vezi pe GitHub →',
    viewAllGithub: 'Vezi toate proiectele pe GitHub →',
    toggleLanguage: 'Schimba limba',
    toggleTheme: 'Schimba tema',
    activityLoading: 'Se incarca activitatea...',
    activityError: 'Nu s-a putut incarca activitatea.',
    activityViewGithub: 'Vezi activitatea pe GitHub',
    pushedTo: 'a facut push in',
    created: 'a creat',
    starred: 'a dat stea la',
    forked: 'a facut fork la',
    openedIssue: 'a deschis un issue in',
    openedPR: 'a deschis un pull request in',
    commentedOn: 'a comentat pe',
    activityIn: 'activitate in',
    justNow: 'chiar acum',
    minuteAgo: 'acum 1 minut',
    minutesAgo: 'minute in urma',
    hourAgo: 'acum 1 ora',
